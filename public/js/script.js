...
async function checkLoginStatus() {
   ...
   let loginStatus = "verified-admin";
   ...
   switch (loginStatus) {
      ...
      case "verified-user":
         ...
         break;
      case "verified-admin":
         loadComponent("header", "components_logged_in_admin/global_components/header.html");
         loadComponent("root", "components_logged_in_admin/home.html");
         break;
